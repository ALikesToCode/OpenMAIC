...
4. **Scene count**: Follow the explicit scene-count guidance above. If the guidance and the default duration heuristic conflict, prefer the guidance.
