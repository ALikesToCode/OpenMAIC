/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c1f469991d4fc81479815ba7e2e4e8cf)
// Runtime types generated with workerd@1.20260401.1 2026-04-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "PDFJobDurableObject" | "MinerUContainer";
	}
	interface Env {
		PDF_JOB_ARTIFACTS: R2Bucket;
		PDF_JOBS_DB: D1Database;
		NAVY_API_KEY: string;
		NAVY_BASE_URL: string;
		NAVY_MODELS: string;
		TAVILY_API_KEY: string;
		DEFAULT_MODEL: string;
		PDF_JOB_DO: DurableObjectNamespace<import("./worker/index").PDFJobDurableObject>;
		MINERU_CONTAINER: DurableObjectNamespace<import("./worker/index").MinerUContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NAVY_API_KEY" | "NAVY_BASE_URL" | "NAVY_MODELS" | "TAVILY_API_KEY" | "DEFAULT_MODEL">> {}
}
